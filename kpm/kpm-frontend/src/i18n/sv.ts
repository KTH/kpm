export const sv: Record<string, string> = {
  ...
  "Help / feedback for the personal menu": "Hjälp och förslag kring personliga menyn",
  "Home page": "Startsida",
  "Relevant information right now. Course registration, Exam registration": "Aktuell information. Kursregistrering, tentaregistrering",
  "My education": "Min utbildning",
  "Overview of your studies. Programmes, courses, results on courses": "Studieöversikt: program, kurser och resultat",
  "Examinations": "Tentor",
  ...
  "News feed": "Nyheter",
  "News from your courses, groups and programmes": "Nyheter om kurser, grupper och program",
  ...
  "Export My schedule (e.g. to your mobile phone)": "Exporter mitt schema (iCal)",
  "Kurs-PM": "Kurs-PM",
  ...
  "Ladok för personal (administratörer och lärare)": "Ladok för personal (administratörer och lärare)",
  ...
  "Artiklar och böcker (KTH Biblioteket)": "Artiklar och böcker (KTH Biblioteket)",
