...
let n = cr('div'); n.id = "kpm-6cf53"; n.style = "inset: 0; position: fixed; height: calc(var(--kpm-bar-height,2em) + 1px); margin: 0 auto; background-color: #65656c;";n.innerHtml = "";document.body.prepend(n);
